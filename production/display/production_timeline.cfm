...
var START=new Date('#dateFormat(timelineStart,"yyyy-mm-dd")#T00:00:00'), DAYS=#viewDays#, PX_PER_DAY=240, MINUTES_PER_PX=1440/PX_PER_DAY, DROP_MODE='insert', DRAGGED_ORDER_ID=null;
