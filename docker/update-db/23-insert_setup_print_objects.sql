...
BEGIN
    ...
    -- Sayfa kayıtları (mevcut varsa güncelle, yoksa ekle)
    DELETE FROM pbs_objects
    WHERE full_fuseaction IN (
        'setup.list_print_templates',
        'setup.add_print_template',
        'setup.save_print_template',
        'setup.delete_print_template',
        'setup.print_document'
    );
