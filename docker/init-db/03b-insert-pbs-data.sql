...
INSERT INTO pbs_objects (object_id, object_name, module_id, show_menu, window_type, full_fuseaction, file_path, order_no, is_active) VALUES (168, 'Hızlı Satış', 24, true, 'standart', 'order.quick_sale', '/order/form/quick_sale.cfm', 1, true);
INSERT INTO pbs_objects (object_id, object_name, module_id, show_menu, window_type, full_fuseaction, file_path, order_no, is_active) VALUES (169, 'Kategori - İş İstasyonu Eşleştirmeleri', 26, true, 'standart', 'production.list_productcategory_workstationgroup_relation', '/production/display/list_productcategory_workstationgroup_relation.cfm', 0, true);
INSERT INTO pbs_objects (object_id, object_name, module_id, show_menu, window_type, full_fuseaction, file_path, order_no, is_active) VALUES (170, 'Kategori - İş İstasyonu Eşleştirme Ekle', 26, false, 'standart', 'production.add_productcategory_workstationgroup_relation', '/production/form/add_productcategory_workstationgroup_relation.cfm', 0, true);
INSERT INTO pbs_objects (object_id, object_name, module_id, show_menu, window_type, full_fuseaction, file_path, order_no, is_active) VALUES (171, 'Kategori - İş İstasyonu Eşleştirme Kaydet', 26, false, 'standart', 'production.save_productcategory_workstationgroup_relation', '/production/form/save_productcategory_workstationgroup_relation.cfm', 0, true);
INSERT INTO pbs_objects (object_id, object_name, module_id, show_menu, window_type, full_fuseaction, file_path, order_no, is_active) VALUES (172, 'Kategori - İş İstasyonu Eşleştirme Sil', 26, false, 'standart', 'production.delete_productcategory_workstationgroup_relation', '/production/form/delete_productcategory_workstationgroup_relation.cfm', 0, true);
